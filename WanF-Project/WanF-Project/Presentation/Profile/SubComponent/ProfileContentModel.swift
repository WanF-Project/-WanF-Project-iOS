...
struct ProfileContentModel {
    ...
    func getProfileValue(_ result: Bool) -> ProfileContent? {
        ...
        return ProfileContent(id: 0, image: "AppIcon", nickname: "원프", entranceYear: "23학번", birth: "23학번", gender: "여자", mbti: "ENFP", personality: ["느긋함", "효율중시", "계획적", "꼼꼼함"], purpose: ["과탑", "친목", "앞자리"], contact: "WanF", major: MajorEntiry(id: 0, name: "IT융합자율학부"))
    }
